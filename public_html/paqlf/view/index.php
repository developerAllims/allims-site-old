...
<div class="bloco_login">
	<form class="login">
		...
		<input type="password" name="senha" placeholder="Senha" autocomplete="off" maxlength="20" value="<?php print isset($_COOKIE['pass']) ? $_COOKIE['pass'] : '' ?>">
