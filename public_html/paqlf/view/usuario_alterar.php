	...
	<form class="alterar_usuario">
		<table border="0">
			<tr>
				...
				<td>
					<input type="text" name="nome" required value="<?php print $user->getNome(); ?>" maxlength="70">
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					<input type="password" name="senha" readonly maxlength="15">
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="password" name="re-senha" readonly maxlength="15">
				</td>
			</tr>
			<tr>
				<td align="right">
