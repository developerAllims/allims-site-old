<?php 
...

	{
...

		{
			...
			$html .= '<tr class="abrir ' . ( ($array_corpo['is_calculed'] == 't' || $array_corpo['is_calculed'] == 'true') && ( $array_corpo['is_visible'] == 't' || $array_corpo['is_visible'] == 'true' ) ? 'calculed' : 'not_calculed' ) . ' " data-id="' . $array_corpo['pk_program_year_samp'] .'">';
