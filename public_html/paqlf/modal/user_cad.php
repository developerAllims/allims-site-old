<?php 
	...
	$mail 		 = strtolower(trim(pg_escape_string($_POST['email'])));
	...
	$query = "INSERT INTO 
					...
					(" . $user->getLaboratorio() .",'". $name ."','". $mail ."','". $pass ."',". $amostra .",". $laboratorio .",". $cad_user .",". $selo ."," . $user->getId() . ", 'NOW()')  RETURNING pk_user";
...

	{
		...
		$query_select = "SELECT * FROM ep_users WHERE pk_user=" . $pk_user['pk_user'];
