...
get_object("barcode").innerHTML=DrawHTMLBarcode_Code128C(get_object("barcode").innerHTML,"yes","cm",0,3.5,0.5,"bottom","center","font-family: 'ProximaNova'; font-size:10pt","black","white");
/* ]]> */
</script>
</body>
</html>
