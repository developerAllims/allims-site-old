	...
	<form class="novo_usuario">
		<table border="0">
			<tr>
				...
				<td>
					<input type="text" name="nome" required maxlength="90">
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input type="text" name="email" class="input_email" required maxlength="90">
				</td>
			</tr>
			<?php if( $_GET['samp'] != '' ) { ?>
			<tr>
			...
			<tr>
				<td colspan="7" align="right" style="border:none;">
					<input type="hidden" name="lab_on" class="lab_on" value="<?php print ($_GET['samp'] != '' ? $_GET['samp'] : '-10'); ?>">
					<a href="<?php print ($_GET['samp'] != '' ? '/laboratorio/usuario/'.$_GET['samp'] : '/usuario'); ?>" class="cancelar">CANCELAR</a>
