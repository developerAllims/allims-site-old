<?php 
...

	{
	    ...
	    $mail->Username = 'senhapaqlf@gmail.com'; // usuario gmail.   

	    $mail->Password = 'a7212685'; // senha do email.
	    ...
	    $mail->SetFrom('senhapaqlf@gmail.com', '=?UTF-8?B?'.base64_encode('Portal PAQLF').'?='); 
